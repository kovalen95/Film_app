...
class Film(models.Model):
    ...
    dodatkowe = models.OneToOneField(DodatkoweInfo, on_delete=models.CASCADE,
                                     null=True, blank=True) #'Dodatkowe' info - mozna zrobic w cudyslowiu
                                                                                # gdyby dodatkowe info bylo po modelu film poniewa
                                                                                #python czyta z gory na dol i rzucal by bledem
    def __str__(self):
